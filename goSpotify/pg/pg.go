...
// NewPG returns a singleton Postgres instance. The logger and connStr from the first call are used for the lifetime of the process.
func NewPG(ctx context.Context, connStr string, logger *slog.Logger) (*Postgres, error) {
	var initErr error
	pgOnce.Do(func() {
...
func (pg *Postgres) CreateUsersTable(ctx context.Context) error {
	...
	pg.logger.Info("created table users")
...
func (pg *Postgres) CreatePodcastTable(ctx context.Context) error {
	...
	pg.logger.Info("created table podcast")
...
func (pg *Postgres) CreateTracksTable(ctx context.Context) error {
	...
	pg.logger.Info("created table track")
...
func (pg *Postgres) CreatePlaybackTable(ctx context.Context) error {
	...
	pg.logger.Info("created table playback")
...
func (pg *Postgres) DropUsersTable(ctx context.Context) error {
	...
	pg.logger.Info("dropped table users")
	return nil
}
...
func (pg *Postgres) DropTrackTable(ctx context.Context) error {
	...
	pg.logger.Info("dropped table track")
	return nil
}
...
func (pg *Postgres) DropPodcastTable(ctx context.Context) error {
	...
	pg.logger.Info("dropped table podcast")
	return nil
}
